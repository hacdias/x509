  ...
  describe("constructor", () => {
    const tests: {
      ...
      },
      {
        ...
        args: {
          type: "guid",
          value: "33636766-DEE4-4AC5-A4AE-AF8380C7A655",
        },
        want: {
          type: "guid",
          value: "33636766-dee4-4ac5-a4ae-af8380c7a655",
      ...
      },
      {
        ...
        args: asn1Schema.AsnConvert.parse(
          Buffer.from("8208736f6d652e636f6d", "hex"),
...
describe("GeneralNames", () => {
  describe("constructor", () => {
    const raw = Buffer.from(
      "302ba41f301d310d300b060355040313046e616d65310c300a060355040a13036f72678208736f6d652e636f6d",
      "hex",
    );

    const tests: {
      name: string;
      args: x509.JsonGeneralNames | asn1X509.GeneralNames | asn1X509.GeneralName[] | BufferSource;
